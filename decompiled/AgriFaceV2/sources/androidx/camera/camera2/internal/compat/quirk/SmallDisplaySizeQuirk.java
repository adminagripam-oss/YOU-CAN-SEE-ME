...
public class SmallDisplaySizeQuirk implements h2 {

    /* renamed from: a  reason: collision with root package name */
    private static final Map f2653a;
    ...
    public static boolean g() {
        return f2653a.containsKey(Build.MODEL.toUpperCase(Locale.US));
    }

    public Size f() {
        return (Size) f2653a.get(Build.MODEL.toUpperCase(Locale.US));
    }
}
