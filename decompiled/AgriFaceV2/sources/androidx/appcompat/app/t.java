...
public abstract class t {
    ...
    public static class a implements Executor {
        ...
        private final Object f1682e = new Object();

        /* renamed from: f  reason: collision with root package name */
        final Queue f1683f = new ArrayDeque();

        /* renamed from: g  reason: collision with root package name */
        final Executor f1684g;
        ...
        protected void c() {
            synchronized (this.f1682e) {
                Runnable runnable = (Runnable) this.f1683f.poll();
                this.f1685h = runnable;
                if (runnable != null) {
                    this.f1684g.execute(runnable);
                }
            }
        }
        ...
        public void execute(final Runnable runnable) {
            synchronized (this.f1682e) {
                this.f1683f.add(new Runnable() { // from class: androidx.appcompat.app.s
