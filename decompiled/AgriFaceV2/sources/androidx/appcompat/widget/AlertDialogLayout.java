...
public class AlertDialogLayout extends o0 {
    ...
    private boolean A(int i8, int i9) {
        ...
        for (int i14 = 0; i14 < childCount; i14++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == g.f.O) {
                    view = childAt;
                } else if (id == g.f.f6872k) {
                    view2 = childAt;
                } else if ((id != g.f.f6874m && id != g.f.f6876o) || view3 != null) {
                    return false;
                } else {
                    view3 = childAt;
                }
    ...
    private void j(int i8, int i9) {
        ...
        for (int i10 = 0; i10 < i8; i10++) {
            ...
            if (childAt.getVisibility() != 8) {
                o0.a aVar = (o0.a) childAt.getLayoutParams();
    ...
    private static int z(View view) {
        int q8 = androidx.core.view.p0.q(view);
        if (q8 > 0) {
            return q8;
        }
    ...
    */
    public void onLayout(boolean r18, int r19, int r20, int r21, int r22) {
        ...
        L5a:
            ...
            r15 = r2
            androidx.appcompat.widget.o0$a r15 = (androidx.appcompat.widget.o0.a) r15
            int r2 = r15.gravity
            if (r2 >= 0) goto L7e
            r2 = r11
        L7e:
            int r3 = androidx.core.view.p0.p(r17)
            int r2 = androidx.core.view.s.a(r2, r3)
            r2 = r2 & 7
            r3 = 1
            if (r2 == r3) goto L95
            r3 = 5
