...
public final class f extends com.google.crypto.tink.shaded.protobuf.x implements q0 {
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f13286a[x.d.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f13286a[x.d.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f13286a[x.d.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f13286a[x.d.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f13286a[x.d.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f13286a[x.d.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    public static final class b extends x.a implements q0 {
        ...
        public b q(com.google.crypto.tink.shaded.protobuf.h hVar) {
            k();
            ((f) this.f6278f).c0(hVar);
            return this;
        }

        public b r(h hVar) {
            k();
            ((f) this.f6278f).d0(hVar);
            return this;
        }
