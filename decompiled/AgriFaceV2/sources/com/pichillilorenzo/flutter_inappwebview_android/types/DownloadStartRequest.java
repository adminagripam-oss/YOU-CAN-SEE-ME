...
public class DownloadStartRequest {
    ...
    public DownloadStartRequest(String str, String str2, String str3, String str4, long j8, String str5, String str6) {
        this.url = str;
        this.userAgent = str2;
    ...
    public int hashCode() {
        ...
        int hashCode = ((((((((this.url.hashCode() * 31) + this.userAgent.hashCode()) * 31) + this.contentDisposition.hashCode()) * 31) + this.mimeType.hashCode()) * 31) + ((int) (j8 ^ (j8 >>> 32)))) * 31;
        String str = this.suggestedFilename;
