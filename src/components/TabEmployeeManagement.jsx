...
export default function TabEmployeeManagement({
  ...
  // [UPDATE]: Threshold dinaikkan dari 0.85 ke 0.92 agar tidak mudah salah deteksi sebagai duplikat.
  const DUPLICATE_THRESHOLD = 0.92; // threshold cosine similarity
