...
const Table = React.forwardRef(({ className, ...props }, ref) => (
  <div className="table-container" style={{ width: '100%', overflowX: 'auto', ...props.style }}>
...
const TableFooter = React.forwardRef(({ className, ...props }, ref) => (
  <tfoot ref={ref} className={`bg-muted/50 font-medium [&>tr]:last:border-b-0 ${className || ''}`} {...props} />
))
